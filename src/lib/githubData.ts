...
export let repositories: Repository[] = [
  ...
  },
  {
    ...
    image:
      "https://caddyserver.com/resources/images/open-graph-square.png?v=1a82466",
  },
  {
    id: 599826625,
    name: "dotfiles",
    ...
    default_branch: "main",
    image:
      "https://pbs.twimg.com/profile_images/1668661956805373957/tmhAvNN9_400x400.jpg",
  },
  {
    id: 668034939,
    ...
    default_branch: "master",
    image:
      "https://static-00.iconduck.com/assets.00/overseerr-icon-2048x2048-5ncr26li.png",
  },
  {
    id: 720284719,
  ...
  },
  {
    ...
    color: { accent: "#555555", dark: "#27272a" },
    description:
      "String manipulation project written in x86 assembly for the 80486 processor",
    owner: "nhitz",
    topics: [],
    stars: 0,
    forks: 0,
    ...
    default_branch: "master",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f8/Intel_A80486-25.jpg/1200px-Intel_A80486-25.jpg",
  },
  {
    id: 132701216,
    name: "MASM4",
    ...
    color: { accent: "#555555", dark: "#27272a" },
    description:
      "Text editor implemented with a linked list, written in x86 assembly",
    owner: "nhitz",
    topics: [],
    stars: 0,
    forks: 0,
  ...
  },
  {
    ...
    color: { accent: "#555555", dark: "#27272a" },
    description:
      "Testing out PrimeVue theming with Vue 3 and Vite. Demo deployed to Azure free tier with GitHub Actions.",
    owner: "nhitz",
    ...
    default_branch: "master",
    image:
      "https://res.cloudinary.com/ddxwdqwkr/image/upload/f_auto/v1689120136/patterns.dev/Images/vue/og-images/introduction.png",
  },
];
